You need to download [LeagueSandbox-Default](https://github.com/lilstav/LeagueSandbox-Default) and place it into `GameServer/GameServerApp/Content/GameMode` after.
